...
public partial class SettingsContext {
    ...
    public SettingsEntity SetGameSettings(LittleHunter.GameSettingsData newValue) {
        if (hasGameSettings) {
    ...
    public void ReplaceGameSettings(LittleHunter.GameSettingsData newValue) {
...
public partial class SettingsEntity {
    ...
    public void AddGameSettings(LittleHunter.GameSettingsData newValue) {
